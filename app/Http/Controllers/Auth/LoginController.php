...
class LoginController extends Controller
{
    ...
    */
    ...
    /**
     * Service to authenticate actions
     */
    ...
    public function __construct(
        MarketAuthenticationService $marketAuthenticationService,
    ...
    {
        $authorizationUrl = $this->marketAuthenticationService
    ...
    /**
     * Create a user session in http client
     * @return void
     */
